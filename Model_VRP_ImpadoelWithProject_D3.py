...
def optimizar_rutas_vrp_d3(orders_out, routes_out, depot_visits_out):
    ...
    try:
        ...
        # ==========================================
        arcpy.AddMessage("Integrando parámetros operativos (Especialidades, Órdenes D3, Depósitos, Vehículos)...")
...
if __name__ == '__main__':
    ...
    # --- Opción A: Rutas estáticas para pruebas locales (activa por defecto) ---
    p_orders_out = fr"{ruta_raiz}\Orders_Project_D3"
    p_routes_out = fr"{ruta_raiz}\Routes_Project_D3"
    p_depot_visits_out = fr"{ruta_raiz}\DepotVisits_Project_D3"
