...
def optimizar_rutas_vrp_d1(orders_out, routes_out, depot_visits_out):
    ...
    try:
        ...
        # ==========================================
        vrp_layer_name = "VRP_Analysis_Layer_D1"
        ...
        # ==========================================
        arcpy.AddMessage("Integrando parámetros operativos (Especialidades, Órdenes D1, Depósitos, Vehículos)...")
...
if __name__ == '__main__':
    ...
    # --- Opción A: Rutas estáticas para pruebas locales (activa por defecto) ---
    p_orders_out      = fr"{ruta_raiz}\Orders_Project_D1"
    p_routes_out      = fr"{ruta_raiz}\Routes_Project_D1"
    p_depot_visits_out = fr"{ruta_raiz}\DepotVisits_Project_D1"
    ...
    optimizar_rutas_vrp_d1(p_orders_out, p_routes_out, p_depot_visits_out)
